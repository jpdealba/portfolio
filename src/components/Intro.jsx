...
function Intro() {
  return (
    <section id="intro" className="flex items-center justify-center flex-col pt-10 pb-6">
      <Name />
      <div className="text-center">
        ...
        <p className="text-sm max-w-xl mb-6 mx-10 tlastc text-justify textLight dark:text-text">
          ...
          suscipit erat, quis condimentum ante tellus sit amet purus erat Aenean eu suscipit. Morbi
          facilisis ac quam nec{' '}
          <a
...
const Name = () => {
  ...
  return (
    <div className="flex flex-row text-center">
      {letterArray.map((value, index) => {
        return <Letter key={index} letter={value} />;
      })}
    </div>
  );
};
